package com.example.syafiqalipah.utilities;
...
import com.example.syafiqalipah.weatherapp.R;

public final class WeatherAppWeatherUtils {
    private static final String LOG_TAG = WeatherAppPreferences.class.getSimpleName();
